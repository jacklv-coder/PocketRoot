...
After that source-review directory verifies, extract the 25 pinned
...
all 25 candidates: `libc-dev` and `zlib` have no remaining indexed items, while
...
review to the exact 85-file payload tree; the verifier rejects path drift,
