...
After that source-review directory verifies, extract the 23 pinned
...
all 23 candidates: `libc-dev` and `zlib` have no remaining indexed items, while
...
review to the exact 83-file payload tree; the verifier rejects path drift,
