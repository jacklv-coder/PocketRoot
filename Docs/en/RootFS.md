...
After that source-review directory verifies, extract the 28 pinned
...
all 28 candidates: `libc-dev` and `zlib` have no remaining indexed items, while
...
review to the exact 88-file payload tree; the verifier rejects path drift,
