...
After that source-review directory verifies, extract the 26 pinned
...
all 26 candidates: `libc-dev` and `zlib` have no remaining indexed items, while
...
review to the exact 86-file payload tree; the verifier rejects path drift,
