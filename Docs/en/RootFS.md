...
After that source-review directory verifies, extract the 22 pinned
...
all 22 candidates: `libc-dev` and `zlib` have no remaining indexed items, while
...
review to the exact 82-file payload tree; the verifier rejects path drift,
