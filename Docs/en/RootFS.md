...
After that source-review directory verifies, extract the 32 pinned
...
all 32 candidates: `libc-dev` and `zlib` have no remaining indexed items, while
...
review to the exact 92-file payload tree; the verifier rejects path drift,
