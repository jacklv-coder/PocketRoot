...
After that source-review directory verifies, extract the 34 pinned
...
all 34 candidates: `libc-dev` and `zlib` have no remaining indexed items, while
...
review to the exact 94-file payload tree; the verifier rejects path drift,
