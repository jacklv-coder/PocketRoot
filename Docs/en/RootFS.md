...
After that source-review directory verifies, extract the 27 pinned
...
all 27 candidates: `libc-dev` and `zlib` have no remaining indexed items, while
...
review to the exact 87-file payload tree; the verifier rejects path drift,
