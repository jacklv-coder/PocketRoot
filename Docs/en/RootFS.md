...
After that source-review directory verifies, extract the 24 pinned
...
all 24 candidates: `libc-dev` and `zlib` have no remaining indexed items, while
...
review to the exact 84-file payload tree; the verifier rejects path drift,
