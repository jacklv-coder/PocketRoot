...
outside-repository tool pins, extracts, and verifies 34 license, attribution,
declaration, and inline-notice candidates across all 10 source origins.
A pinned result manifest records engineering review of all 34 candidates.
...
results manifest binds engineering review to the exact 94-file payload tree.
...
- [x] Complete checksum-bound engineering review of all 34 pinned
...
- [x] Complete checksum-bound engineering review of all 94 external candidate
