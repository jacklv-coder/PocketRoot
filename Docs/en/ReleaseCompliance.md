...
candidate bundle for those origins: 11 remote license/attribution payloads,
...
results manifest binds engineering review to the exact 78-file payload tree.
...
- [x] Complete checksum-bound engineering review of all 78 external candidate
