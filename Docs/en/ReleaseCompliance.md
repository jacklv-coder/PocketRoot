...
outside-repository tool pins, extracts, and verifies 24 license, attribution,
declaration, and inline-notice candidates across all 10 source origins.
A pinned result manifest records engineering review of all 24 candidates.
...
results manifest binds engineering review to the exact 84-file payload tree.
...
- [x] Complete checksum-bound engineering review of all 24 pinned
...
- [x] Complete checksum-bound engineering review of all 84 external candidate
