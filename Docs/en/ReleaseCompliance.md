...
outside-repository tool pins, extracts, and verifies 23 license, attribution,
declaration, and inline-notice candidates across all 10 source origins.
A pinned result manifest records engineering review of all 23 candidates.
...
results manifest binds engineering review to the exact 83-file payload tree.
...
- [x] Complete checksum-bound engineering review of all 23 pinned
...
- [x] Complete checksum-bound engineering review of all 83 external candidate
