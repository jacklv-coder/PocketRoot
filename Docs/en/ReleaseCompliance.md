...
outside-repository tool pins, extracts, and verifies 32 license, attribution,
declaration, and inline-notice candidates across all 10 source origins.
A pinned result manifest records engineering review of all 32 candidates.
...
results manifest binds engineering review to the exact 92-file payload tree.
...
- [x] Complete checksum-bound engineering review of all 32 pinned
...
- [x] Complete checksum-bound engineering review of all 92 external candidate
