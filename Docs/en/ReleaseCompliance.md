...
outside-repository tool pins, extracts, and verifies 25 license, attribution,
declaration, and inline-notice candidates across all 10 source origins.
A pinned result manifest records engineering review of all 25 candidates.
...
results manifest binds engineering review to the exact 85-file payload tree.
...
- [x] Complete checksum-bound engineering review of all 25 pinned
...
- [x] Complete checksum-bound engineering review of all 85 external candidate
