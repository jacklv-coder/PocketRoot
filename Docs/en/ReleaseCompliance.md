...
outside-repository tool pins, extracts, and verifies 28 license, attribution,
declaration, and inline-notice candidates across all 10 source origins.
A pinned result manifest records engineering review of all 28 candidates.
...
results manifest binds engineering review to the exact 88-file payload tree.
...
- [x] Complete checksum-bound engineering review of all 28 pinned
...
- [x] Complete checksum-bound engineering review of all 88 external candidate
