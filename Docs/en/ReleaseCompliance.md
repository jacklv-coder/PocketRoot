...
outside-repository tool pins, extracts, and verifies 22 license, attribution,
declaration, and inline-notice candidates across all 10 source origins.
A pinned result manifest records engineering review of all 22 candidates.
...
results manifest binds engineering review to the exact 82-file payload tree.
...
- [x] Complete checksum-bound engineering review of all 22 pinned
...
- [x] Complete checksum-bound engineering review of all 82 external candidate
