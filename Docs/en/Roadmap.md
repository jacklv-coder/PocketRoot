...
| License-reviewed RootFS | Blocked | The 15-package inventory, 10 source origins, SPDX SBOM, and default-configuration evidence are complete; add the full license/NOTICE and corresponding-source bundles plus authorized approval |
