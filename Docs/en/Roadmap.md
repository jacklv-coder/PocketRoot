...
| License-reviewed RootFS | Blocked | The 15-package/10-origin evidence and engineering review of all 21 candidates are complete; close the remaining items for eight origins, finish corresponding-source delivery review, and obtain authorized approval |
