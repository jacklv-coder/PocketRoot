...
| License-reviewed RootFS | Blocked | The 15-package/10-origin evidence, all 22 initial candidates, and all 82 external payloads have checksum-bound engineering review; three origins have no remaining candidate-material engineering items, five still need package-specific material, followed by legal review, corresponding-source delivery review, and authorized approval |
