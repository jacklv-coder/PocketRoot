...
| License-reviewed RootFS | Blocked | The 15-package/10-origin evidence and engineering review of all 21 candidates are complete; the eight remaining origins now have a checksum-bound external candidate index and materializer, so next complete engineering/legal review of those payloads, corresponding-source delivery review, and authorized approval |
