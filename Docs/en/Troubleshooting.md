...
Timeout must be positive and no longer than 24 hours. Positive sub-millisecond values become 1 ms. A timed-out result can contain partial bounded output; check `timedOut` first.
