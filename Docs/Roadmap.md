...
| License-reviewed RootFS | 阻塞 | 15 包 inventory、10 source origin、SPDX SBOM、默认配置证据、外置源码获取流程和 21/21 候选工程复核已完成；剩余 8 个 origin 的外置候选包已有 checksum-bound 索引与 materializer，下一步完成候选材料工程/法律复核、对应源码交付审查与负责人批准 |
