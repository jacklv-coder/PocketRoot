...
| App lifecycle 与内存 | 进行中 | Simulator 与 Jack iPhone 均有 256 MiB `ru_maxrss` 门禁，真机 process suspend/resume 与 UIKit foreground/background 已通过；补真机 jetsam、failure injection、persistence |
